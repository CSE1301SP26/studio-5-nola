...
public class Methods {
	...
	public static double distanceBetween(double x1, double y1, double x2, double y2) {
		// double formula = Math.sqrt(Math.pow(x2-x1) + Math.pow(y2-y1));

		double xPostion = Math.pow(x2 - x1, 2);
		double yPostion = Math.pow(y2 - y1, 2);
		double distance = Math.sqrt(xPostion + yPostion);
